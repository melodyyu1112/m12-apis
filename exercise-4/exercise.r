...
query.parameters <- list(t = fav.movie)
...
move_data <- as.data.frame(movie.data)

# /????//////;pWrite a function called Director that accepts a data frame of movie info and returns
